...
RSpec.feature "UserCanPlaceOrderAndViewPreviousOrder", type: :feature do
  scenario "user places order and views previous orders" do
    ...
    description:"Ethiopian coffee is super good", image_url:"http://www.ethiopia-xperience.com/images/Pics_uploaded_by_Jos/EthiopianCoffee2010_586.jpg")
    user = User.create(first_name: "John", last_name: "Adams",
