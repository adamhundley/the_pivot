...
RSpec.feature "UserAddsProductToCart", type: :feature do
  scenario "user adds product to cart" do
    ...
    product2 = category.products.create(name:"Columbian", price:1800, description:"Columbian coffee is super good", image: open("http://www.ethiopia-xperience.com/images/Pics_uploaded_by_Jos/EthiopianCoffee2010_586.jpg"))
